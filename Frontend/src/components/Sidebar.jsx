    ...
    <>
      <aside className="w-64 bg-[#0a0a0a]/95 backdrop-blur-xl border-r border-white/10 flex flex-col shrink-0 shadow-[4px_0_24px_rgba(0,0,0,0.4)] relative z-10 transition-all duration-500">
        ...
        <div className="p-4 border-t border-slate-900 bg-slate-950/50">
          ...
          >
            <div 
              className="relative w-9 h-9 rounded-xl border border-blue-500/20 bg-gradient-to-br from-blue-600 to-indigo-700 text-white flex items-center justify-center font-bold text-sm shadow-md shadow-blue-500/20 overflow-hidden"
            >
              {avatarUrl ? (
            ...
            <div className="overflow-hidden flex-1">
              ...
              <p className="text-[9px] text-red-500 font-extrabold uppercase tracking-wider group-hover:text-red-400 transition-colors">THÔNG TIN</p>
            </div>
