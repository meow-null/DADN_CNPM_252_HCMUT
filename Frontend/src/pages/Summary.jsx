            ...
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-slate-100">
                <tr className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="px-6 py-4 font-bold">{activeProject?.input_P ?? '-'}</td>
                  <td className="px-6 py-4 text-slate-400 text-sm">mm</td>
                  <td className="px-6 py-4 text-emerald-500 font-medium">OK</td>
                </tr>
                <tr className="hover:bg-slate-50 transition-colors">
                  <td className="px-6 py-4 text-sm text-slate-700">Tỷ số truyền chung</td>
                  <td className="px-6 py-4 font-mono text-slate-400">u_ch</td>
                  <td className="px-6 py-4 font-bold">{kinematics?.u_ch_sb ?? '-'}</td>
