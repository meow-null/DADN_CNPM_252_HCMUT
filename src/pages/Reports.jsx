      ...
      <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-slate-100">
            <tr><td className="px-8 py-5 font-medium">Công suất</td><td className="px-8 py-5 text-slate-400 font-mono">P</td><td className="px-8 py-5 text-slate-400">kW</td><td className="px-8 py-5 text-right font-bold text-primary text-lg">15</td></tr>
            <tr><td className="px-8 py-5 font-medium">Số vòng quay</td><td className="px-8 py-5 text-slate-400 font-mono">n</td><td className="px-8 py-5 text-slate-400">vòng/phút</td><td className="px-8 py-5 text-right font-bold text-primary text-lg">120</td></tr>
            <tr><td className="px-8 py-5 font-medium">Tỷ số truyền</td><td className="px-8 py-5 text-slate-400 font-mono">u</td><td className="px-8 py-5 text-slate-400">-</td><td className="px-8 py-5 text-right font-bold text-primary text-lg">10</td></tr>
          </tbody>
        </table>
      </div>
