    ...
    <aside className="w-64 bg-white border-r border-slate-200 flex flex-col shrink-0">
      ...
      <div className="p-4 border-t border-slate-100">
        <div className="flex items-center gap-3 p-2 bg-slate-50 rounded-xl cursor-pointer hover:bg-slate-100 transition-colors" onClick={onLogout}>
          <img alt="Avatar" className="w-10 h-10 rounded-full border-2 border-white shadow-sm" src="https://lh3.googleusercontent.com/aida-public/AB6AXuARVYhK1DYrCGfVf_7_FJMoZU1SmPYjSlkV3sHNL1-Vx0gY4Llix6B33ncHDSEQini5IAPUEKVRfsdQlC7JujEsvobuceJSctqmEw7Rr0IXC1PSYH7i0kyEQJ7Ra9fCQrnbNqQ6GSaXVNJ2kUH8588x0HdQ91mZnSonxnbW0QTJuocAeDKsOzTXt2t7nF3EWxbYPAQsbmZJd-jkyxEJdT6E-2wKwERJ1t29GgiocjVsG9TXEdchZguLPvskzeByYldjAN2CMtNW_w"/>
